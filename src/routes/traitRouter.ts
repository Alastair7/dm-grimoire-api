...
const traitRouter: Router = express.Router();

const traitService: ITraitService = new TraitService();
const traitController: TraitController = new TraitController(traitService);

traitRouter.get("/", traitController.getTraits);
